...
freq_in_full_corpus_no_twice_dict={k:v for k,v in freq_in_full_corpus_dict.items() if v>2} #Слова которые встречаются более двух раз в рамках всего сборника (Мешок слов)
